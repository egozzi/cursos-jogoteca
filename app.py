...
usuario1 = Usuario('erico', 'Erico Murilo Gozzi', 'senha123')
usuario2 = Usuario('fulano', 'Fulano de Tal', 'outraSenha')
usuario3 = Usuario('beltrano', 'Beltrano de Tal', 'maisUmaSenha')
usuarios = {
